  ...
  <div className='overflow-x-hidden'>
    ...
    <div className=' w-full lg:h-[600px] md:h-[100vh] xs:min-h-[100vh] md:gap-0 xs:gap-20 flex items-center md:flex-nowrap xs:flex-wrap lg:pb-0 md:pb-10 xs:pb-20 md:pt-0 xs:pt-5 lg:justify-around md:justify-between xs:justify-center md:pr-12 xs:pr-7 bg-[#FAF4F4]'>
      ...
      <div className='flex flex-col lg:w-[550px] lg:h-[550px] md:w-[340px] md:h-[340px] xs:w-[250px] xs:h-[250px] items-center justify-start'>
        ...
        <div className='font-medium flex flex-col lg:gap-6 md:gap-4 xs:gap-2'>
          ...
          <button className='lg:w-[125px] md:w-max xs:w-max lg:h-[49px] md:h-[39px] lg:text-2xl md:text-lg xs:text-base border-black border-b-2'>View More</button>
        </div>
      </div>
    ...
    <div className=' flex flex-col items-center justify-around xs:py-10 w-full lg:h-[750px] xs:min-h-[150vh] bg-white'>
      <div className='flex flex-col items-center font-medium lg:gap-5 xs:gap-3'>
        ...
        <p className=' lg:text-base xs:text-sm xs:text-center text-[#9f9f9f]'>Find a bright ideal to suit your taste with our great selection of suspension, floor and table lights.</p>
      </div>
      ...
      <div>
        <button className=' lg:w-[115px] md:w-max xs:w-max lg:h-[45px] md:h-[35px] xs:h-[30px] border-black border-b-2 font-medium text-center md:mt-16 lg:text-xl md:text-base xs:mt-10'>View More</button>
      </div>
    ...
    <div className='w-full lg:h-[550px] md:h-[80vh] xs:h-[100vh] flex md:flex-row xs:flex-col items-center md:justify-between xs:justify-around bg-[#FFF9E5]'>
      ...
      <div className=' flex flex-col items-center justify-between md:mr-10 text-center md:gap-10 xs:gap-6'>
        <div>
          <p className=' font-medium lg:text-2xl md:text-xl xs:text-lg'>New Arrivals</p>
          <p className=' font-bold lg:text-5xl md:text-4xl xs:text-3xl'>Asgaard Sofa</p>
        </div>
        <div>
          <button className=' font-normal lg:text-xl xs:text-lg border-[1px] lg:py-2 xs:py-1 lg:px-8 md:px-6 xs:px-5 border-black'>Order Now</button>
        </div>
      </div>
    </div>
    ...
    <div className=' flex flex-col items-center justify-around w-full lg:py-0 xs:py-10 lg:h-[850px] xs:min-h-[100vh] bg-slate-100'>
      <div className='flex flex-col items-center font-medium lg:gap-5 xs:gap-3'>
        ...
        <p className=' lg:text-base xs:text-sm text-center text-[#9f9f9f]'>Find a bright ideal to suit your taste with our great selection</p>
      </div>
      ...
      <div className='text-center md:mt-0 xs:mt-24'>
        <Link href={'/blogs'}><p className=' lg:w-[150px] md:w-max lg:h-[49px] md:h-[39px] border-black border-b-2 font-medium text-center lg:text-xl xs:text-lg'>View All Posts</p></Link>
      </div>
