      ...
      <div className="flex items-center justify-around w-full h-[100px] bg-[#FAF4F4]">
        ...
        <div className="flex items-center gap-10 font-normal text-xl">
          <div className="flex items-center gap-5">
            ...
            <div className="w-[55px] h-[55px] bg-white text-gray-400 flex items-center justify-center">
              <span>16</span>
            </div>
          </div>
          <div className="flex items-center gap-5">
            ...
            <div className="w-[180px] h-[55px] bg-white text-gray-400 flex items-center justify-center">
              <span>Default</span>
            </div>
          </div>
        </div>
