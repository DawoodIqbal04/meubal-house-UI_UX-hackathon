            ...
            <div className='flex justify-between h-[312px] w-[100%] '>
              ...
              <div className='flex items-start justify-between w-[700px] font-medium text-base'>
                ...
                <div className='flex flex-col gap-12'>
                  ...
                  <div><Link href={""}>Payment Options</Link></div>
                  <div><Link href={""}>Returns</Link></div>
                  <div><Link href={""}>Privacy Policies</Link></div>
                </div>
                <div className='flex flex-col gap-12'>
                  <div className=' text-[#9f9f9f]'>Newsletter</div>
                  <div className='flex gap-3'>
                    <input type="email" placeholder='Enter Your Email Adress' className=' border-b-[1.5px] border-black bg-transparent outline-none text-base font-normal'/>
                    <button type='submit' value={'Subscribe'} className=' border-b-[1.5px] border-black '>Subscribe</button>
                  </div>
                </div>
              </div>
            </div>
